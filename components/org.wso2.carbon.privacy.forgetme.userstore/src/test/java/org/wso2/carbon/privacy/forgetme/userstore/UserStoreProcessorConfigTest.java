...
public class UserStoreProcessorConfigTest {
    ...
    public void init() {
        ...
        properties.put("org.wso2.carbon.user.core.ldap.ReadWriteLDAPUserStoreManager", "read-write-ldap-handler");
    ...
    public void testGetUserStoreHandlerForPrimaryUserStore() throws Exception {
        ...
        UserStoreHandler handler = userStoreProcessorConfig.getUserStoreHandler(-1234, userStoreDomainName);
    ...
    public void testGetUserStoreHandlerForTenantSecondaryUserStore() throws Exception {
        ...
        UserStoreHandler handler = userStoreProcessorConfig.getUserStoreHandler(1, userStoreDomainName);
